...
<section className="relative min-h-screen flex items-center justify-center overflow-hidden">
  ...
  <div className="container relative z-10 text-center py-32">
    ...
    <motion.div
      ...
      animate={{ opacity: 1 }}
      transition={{ delay: 1 }}
      className="flex flex-wrap gap-8 justify-center mt-80"
    >
      <Link to="/contact">
        <Button
          size="lg"
...
<section className="py-24 bg-black">
  <div className="container max-w-2xl mx-auto">
    ...
    {/* Services */}
    <section className="container py-16">
      <h2 className="text-3xl font-display font-bold text-center mb-2">Our <span className="text-hindu-red">Services</span></h2>
      <p className="text-muted-foreground text-center mb-10">Book an offline consultation or get your Kundli prepared</p>
      <div className="overflow-hidden">
        <motion.div 
          className="flex gap-6"
          animate={{ x: [0, -320 * 8 - 24 * 7] }}
          transition={{ 
            x: {
              repeat: Infinity,
              repeatType: "loop",
